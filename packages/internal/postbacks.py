...
subscriptions_reply = [QuickReply(title="Media & Publications",
                                  payload="Subscriptions/media&publications"),
                       QuickReply(title="Technology & Engineering",
                                  payload="Subscriptions/technology&engineering"),
                       QuickReply(title="Political",
                                  payload="Subscriptions/political"),
                       QuickReply(title="Environmental",
                                  payload="Subscriptions/environmental"),
                       QuickReply(title="Medicine",
                                  payload="Subscriptions/medicine"),
                       QuickReply(title="Music & Dance",
                                  payload="Subscriptions/music&dance"),
                       QuickReply(title="Science",
                                  payload="Subscriptions/science"),
                       QuickReply(title="Service",
